...
!! By Zhang for C/N cycling
      ...
      !! Soil Moisture Data Assimilation, by Amol
      real, dimension(:), allocatable :: sm1
      real, dimension(:,:), allocatable :: ens_samp 
      real, dimension(:,:), allocatable :: ens_precip
      real, dimension(:,:), allocatable :: rand_da,rand_da_cn
      real, dimension(:,:), allocatable :: rand_da_sm1,rand_da_sm2
      real, dimension(:,:), allocatable :: rand_da_sm3,rand_da_en
      real, dimension(:,:), allocatable :: ens_surfq_l
      real, dimension(:,:), allocatable :: ens_sepday
      real, dimension(:,:), allocatable :: ens_sw_excess
      real, dimension(:,:), allocatable :: ens_qlyr
      real, dimension(:,:), allocatable :: ens_ul_excess
      real, dimension(:,:), allocatable :: ens_sol_sw
      real, dimension(:,:), allocatable :: ens_surfq
      real, dimension(:,:), allocatable :: ens_inflpcp
      real, dimension(:,:), allocatable :: ens_ho
      real, dimension(:,:), allocatable :: ens_latlyr
      real, dimension(:,:), allocatable :: smobs,pcp_stn,sm_dqx,sm_rfi
      real, dimension(:,:), allocatable :: ens_sev
      real, dimension(:,:), allocatable :: ens_esleft
      real, dimension(:,:), allocatable :: inflow_flag
      real, dimension(:,:), allocatable :: da_flag
      real, dimension(:,:), allocatable :: KG_all
      real, dimension(:,:), allocatable :: cn_flag
      real, dimension(:,:), allocatable :: sm_std_obs_all
      real, dimension(:,:), allocatable :: precipday_all
      real, dimension(:), allocatable :: peakr_write
      real, dimension(:,:), allocatable :: sm_max
      real, dimension(:,:), allocatable :: a_smar
      real, dimension(:,:), allocatable :: b_smar
      real, dimension(:,:), allocatable :: sw2_smar
      real, dimension(:,:), allocatable :: sc1_smar
      real, dimension(:,:), allocatable :: tmstp_all
      real, dimension(:,:), allocatable :: sm_obs1
      real, dimension(:,:), allocatable :: sm_obs2
      
      real :: cndummy(1826)
      real :: fcl1,fcl2,fcl3
      
      real, dimension(:,:,:), allocatable :: ens_sol_st,ens_sol_st_1
      real, dimension(:,:,:), allocatable :: ens_sol_fc
      
      
      integer :: n_days_sim, n_en_member, n_ensembles, n_parameters, 
     & n_sampling_method,samp_nrows, samp_ncolumns
           
      integer :: da, da_daycount, cnt_strt, cnt_end, wrdtf, da_stopday
      integer :: da_alg, smsat
      real :: pcp_std_par, sol_st_std, sm_dqx_co, sm_std1, sm_std2
      real :: fcpercent,fcpercent2,cn_std,sm_rfi_co
      
      
      !Kalman Filter
      real, dimension(:,:), allocatable :: xbb, y, xaa, err_xb, err_y
      real, dimension(:,:), allocatable :: st_er_cov, obs_er_cov, 
     & st_obs_cov, kalman_gain, st_par_cov, xbb_1
      integer :: no_sta_var, no_obs_var
      
      ! soil depth calibration
      integer :: z1_depth
      character :: outputfilename*3, outputfile*25
      
      !miscellaneous
      !cn_subroutine_counter
      real :: cn_sb_count
